    ...
    <div class="main">
        <main class="content">
            <div  class="container-fluid p-0">
                <div  class="card">
                    <form action="<%=request.getContextPath()%>/ProductServlet?action=Creat" name="submitForm"
                          id="submitForm" method="post" enctype="multipart/form-data">

                        <div class="card-header">
                            <div class="container-fluid">
                                <button id="buttonAdd" type="submit" class="btn btn-primary"> Add new Product</button>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div style=" width: 100%;display: inline-flex; align-items: center">
                            <div style="width: 45%; margin-top: 20px; margin-left:  20px; ">
                                <div class="input-group mb-3">
                                    <span class="input-group-text btn btn-primary" id="newProductName"><i
                                ...
                                <div class="input-group mb-3">
                                    <label class="input-group-text btn btn-primary" for="idParent"><i
                                    ...
                                    <select class="form-select" name="newCatalogParent" id="idParent">
                                        ...
                                        <c:forEach items="${listCat}" var="cat">
                                            <option value="${cat.catalogId}">[${cat.parentName}] ${cat.catalogName}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                <div class="input-group mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-text btn btn-primary" id="file1"><i class="bi bi-images"></i></span>
                            ...
                            <div style=" width: 45%; margin-top: 20px; margin-left:  65px; ">
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-text btn btn-primary" id="discount"><i
                                            class="bi bi-arrow-down-right-square"></i></span>
                                        <input style="" type="text" name="discount" value="0" class="form-control"
                                           placeholder="Discount..."
                                           aria-label="Sizing example input"
                                           aria-describedby="inputCatalogName">
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text btn btn-primary" id="file"><i class="bi bi-images"></i></span>
                        ...
                        <div id="descrip" style=" border-radius: 5px; margin: 20px  " name="">
                            <textarea name="description" id="description" style="width: 100% "></textarea>
                        </div>
                    </form>
                    <div id="content" style="display:none ">
                        <form id="submitFormDetail" nam="submitFormDetail"
                              action="<%=request.getContextPath()%>/ProductServlet?action=CreatDetail" method="post">
                            <input type="hidden" id="productId" name="productId" >
                            <div class="card-header" style=" width:96%;display:  inline-flex;margin: 20px ; align-items: center">
                                <div style="width: 45%; margin-top: 20px; margin-left:  20px; ">
                                    <div class="input-group mb-3" style="display: inline-flex;">
                                        <div class="input-group " style="width: 47%">
                                            <label class="input-group-text btn btn-primary" for="inputGroupSelect02"><i
                                        ...
                                        <div class="input-group " style="width: 47%; margin-left: 6%">
                                            <label class="input-group-text btn btn-primary" for="inputGroupSelect01"><i
                                    ...
                                    <div class="input-group mb-3" style="display: inline-flex;">
                                        <div class="input-group " style="width: 47%">
                                            <span class="input-group-text btn btn-primary" ><i class="bi bi-cash-coin"></i></span>
                                            <input style="" type="text" name="exportPrice" class="form-control"
                                                   placeholder="Export price..."
                                                   aria-label="Sizing example input"
                                                   aria-describedby="inputCatalogName">
                                        </div>
                                        <div class="input-group " style="width: 47%; margin-left: 6%">
                                            <span class="input-group-text btn btn-primary" ><i class="bi bi-sort-numeric-down"></i></span>
                                            <input style="" type="text" name="quantityDetail" class="form-control"
                                ...
                                <div style=" width: 45%; margin-top: 20px; margin-left:  65px; ">
                                    <div class="input-group mb-3">
                                    <span class="input-group-text btn btn-primary" id="discountDetail"><i
                                            class="bi bi-arrow-down-right-square"></i></span>
                                        <input style="" type="text" name="discountDetail" value="0" class="form-control"
                                    ...
                                    <div class="input-group mb-3" style="display: inline-flex;">
                                            <div class="container-fluid " style="width: 45%;">
                                                <button type="submit" class="btn btn-primary"> Add product detail
                                                </button>

                    ...
                    <form action="<%=request.getContextPath()%>/ProductServlet?action=Creat" name="submitForm"
                        ...
                        <div class="card-header">
                            <div class="container-fluid">
                                <button id="buttonAdd" type="submit" class="btn btn-warning"> Update Product</button>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div style=" width: 100%;display: inline-flex; align-items: center">
                            <div style="width: 45%; margin-top: 20px; margin-left:  20px; ">
                                <div class="input-group mb-3 ">
                                    ...
                                    <input style="" type="text" value="${pro.productName}" name="newProductName" class="form-control"
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input style="" type="text" value="${pro.tittle}" name="newProductTitle"
                                           class="form-control"
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input style="" type="file" name="productImg" value="${pro.productImg}"
                                           class="form-control"
                                           aria-label="Sizing example input"
                                           aria-describedby="inputCatalogName">
                                </div>
                            ...
                            <div style=" width: 45%; margin-top: 20px; margin-left:  65px; ">
                                ...
                                <span class="input-group-text btn btn-primary" id="createdDate"><i
                                    ...
                                    <input style="" type="date" value="${pro.creatDate}" name="createdDate" class="form-control"
                                           aria-label="Sizing example input"
                                           aria-describedby="inputCatalogName">
                                </div>
                                <div class="input-group mb-3">
                                    ...
                                    <input style="" type="text" name="importPrice" value="${pro.importPrice}"
                                           class="form-control"
                                ...
                                <div class="input-group mb-3" style="display: inline-flex;">
                                    <div class="input-group " style="width: 47%">
                                        ...
                                        <input style="" type="text" name="discount" value="${pro.discount}"
                                               class="form-control"
                                    ...
                                    <div class="input-group " style="width: 47%; margin-left: 6%">
                                        <span  class="input-group-text  btn btn-primary " ><i class="bi bi-toggles"></i></span>
                                        <select  class="form-control" name="updateStatus" id="updateStatus">
                                            <option value="${pro.productStatus}">Choice Status...</option>
                        ...
                        <div id="descrip" style=" border-radius: 5px; margin: 20px ">

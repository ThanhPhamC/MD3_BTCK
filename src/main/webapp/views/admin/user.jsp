                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                          ...
                          <c:forEach items="${listUser}" var="user">
                            <tr>
                                ...
                                <td>${user.email}</td>
                                <td>${user.userStatus? 'Online':'Lock'}</td>
                                <td>   <button type="button" id="delete" class="btn btn-outline-danger"
                                               data-bs-toggle="modal" data-bs-target="#lockAndUnlock"
                                               ><i class="bi bi-toggles"></i>
                                    <input type="hidden" value="${user.userId}" id="userId" >
                                    <input type="hidden" value="${user.fullName}" id="userName" >
                                </button> </td>
                            </tr>
                          </c:forEach>
                            </tbody>
...
<div class="modal fade" id="lockAndUnlock" tabindex="-1" aria-labelledby="deleteModalLabel"
     aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="<%=request.getContextPath()%>/UserServlet" method="post">
                <div class="modal-body">
                    <input style="width: 100%" type="text"  id="deletePro" readonly>
...
<script type="text/javascript">
    $(document).on('click', 'table #delete', function () {
        ...
        let UserName = $(this).parent().find('#userName').val();
        $('#deletePro').val('Xác nhận xoá " ' + UserName + ' " khỏi danh sách !');
        $('#nameDelete').val(userId);
    })

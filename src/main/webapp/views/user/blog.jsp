...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__logo">
            <a href="<%=request.getContextPath()%>/views/user/index.jsp"><img src="<%=request.getContextPath()%>/views/img/logo.png" alt=""></a>
        </div>
                ...
                <div class="col-lg-3">
                    <div class="header__right">
                        ...
                        <ul class="header__right__widget">
                            <li><span class="icon_search search-switch"></span></li>
                            <li><a href="<%=request.getContextPath()%>/views/user/wishlist.jsp"><span class="icon_heart_alt"></span>
                                <div class="tip">2</div>
                            </a></li>
                            <li><a href="<%=request.getContextPath()%>/views/user/shop-cartDetail.jsp"><span class="icon_bag_alt"></span>
                                <div class="tip">2</div>
                            </a></li>
                        </ul>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic large__item set-bg" data-setbg="<%=request.getContextPath()%>/views/img/blog/blog-1.jpg"></div>
                    ...
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="<%=request.getContextPath()%>/views/img/blog/blog-7.jpg"></div>
                        <div class="blog__item__text">
                    ...
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="<%=request.getContextPath()%>/views/img/blog/blog-9.jpg"></div>
                        <div class="blog__item__text">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="<%=request.getContextPath()%>/views/img/blog/blog-2.jpg"></div>
                        <div class="blog__item__text">
                    ...
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="<%=request.getContextPath()%>/views/img/blog/blog-4.jpg"></div>
                        <div class="blog__item__text">
                    ...
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="<%=request.getContextPath()%>/views/img/blog/blog-8.jpg"></div>
                        <div class="blog__item__text">
                    ...
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="<%=request.getContextPath()%>/views/img/blog/blog-10.jpg"></div>
                        <div class="blog__item__text">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="<%=request.getContextPath()%>/views/img/blog/blog-3.jpg"></div>
                        <div class="blog__item__text">
                    ...
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="<%=request.getContextPath()%>/views/img/blog/blog-5.jpg"></div>
                        <div class="blog__item__text">
                    ...
                    <div class="blog__item">
                        <div class="blog__item__pic large__item set-bg" data-setbg="<%=request.getContextPath()%>/views/img/blog/blog-6.jpg"></div>
                        <div class="blog__item__text">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                    <div class="instagram__item set-bg" data-setbg="<%=request.getContextPath()%>/views/img/instagram/insta-1.jpg">
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                    <div class="instagram__item set-bg" data-setbg="<%=request.getContextPath()%>/views/img/instagram/insta-2.jpg">
                        <div class="instagram__text">
                            <i class="fa fa-instagram"></i>
                            <a href="#">@ ashion_shop</a>
                        </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                    <div class="instagram__item set-bg" data-setbg="<%=request.getContextPath()%>/views/img/instagram/insta-3.jpg">
                        <div class="instagram__text">
                            <i class="fa fa-instagram"></i>
                            <a href="#">@ ashion_shop</a>
                        </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                    <div class="instagram__item set-bg" data-setbg="<%=request.getContextPath()%>/views/img/instagram/insta-4.jpg">
                        <div class="instagram__text">
                            <i class="fa fa-instagram"></i>
                            <a href="#">@ ashion_shop</a>
                        </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                    <div class="instagram__item set-bg" data-setbg="<%=request.getContextPath()%>/views/img/instagram/insta-5.jpg">
                        <div class="instagram__text">
                            <i class="fa fa-instagram"></i>
                            <a href="#">@ ashion_shop</a>
                        </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                    <div class="instagram__item set-bg" data-setbg="<%=request.getContextPath()%>/views/img/instagram/insta-6.jpg">
                        <div class="instagram__text">
                            <i class="fa fa-instagram"></i>
                            <a href="#">@ ashion_shop</a>
                        </div>

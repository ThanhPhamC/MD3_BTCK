            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        ...
                        <a href="<%=request.getContextPath()%>/views/user/blog.jsp">Blog</a>
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="blog__details__content">
                        <div class="blog__details__item">
                            <img src="<%=request.getContextPath()%>/views/img/blog/details/blog-details.jpg" alt="">
                        ...
                        <div class="blog__details__comment">
                            ...
                            <div class="blog__comment__item">
                                <div class="blog__comment__item__pic">
                                    <img src="<%=request.getContextPath()%>/views/img/blog/details/comment-1.jpg" alt="">
                                </div>
                            ...
                            <div class="blog__comment__item blog__comment__item--reply">
                                <div class="blog__comment__item__pic">
                                    <img src="<%=request.getContextPath()%>/views/img/blog/details/comment-2.jpg" alt="">
                                </div>
                                <div class="blog__comment__item__text">
                                    <h6>Brandon Kelley</h6>
                            ...
                            <div class="blog__comment__item">
                                <div class="blog__comment__item__pic">
                                    <img src="<%=request.getContextPath()%>/views/img/blog/details/comment-3.jpg" alt="">
                                </div>
                                <div class="blog__comment__item__text">
                                    <h6>Brandon Kelley</h6>
                                    <p>Duis voluptatum. Id vis consequat consetetur dissentiet, ceteros commune perpetua
                        ...
                        <div class="blog__sidebar__item">
                            ...
                            <a href="#" class="blog__feature__item">
                                <div class="blog__feature__item__pic">
                                    <img src="<%=request.getContextPath()%>/views/img/blog/sidebar/fp-1.jpg" alt="">
                                </div>
                            ...
                            <a href="#" class="blog__feature__item">
                                <div class="blog__feature__item__pic">
                                    <img src="<%=request.getContextPath()%>/views/img/blog/sidebar/fp-2.jpg" alt="">
                                </div>
                                <div class="blog__feature__item__text">
                                    <h6>Amf Cannes Red Carpet Celebrities Kend...</h6>
                                    <span>Seb 17, 2019</span>
                            ...
                            <a href="#" class="blog__feature__item">
                                <div class="blog__feature__item__pic">
                                    <img src="<%=request.getContextPath()%>/views/img/blog/sidebar/fp-3.jpg" alt="">
                                </div>
                                <div class="blog__feature__item__text">
                                    <h6>Amf Cannes Red Carpet Celebrities Kend...</h6>
                                    <span>Seb 17, 2019</span>

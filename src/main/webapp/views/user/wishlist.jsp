            ...
            <div class="col-xl-6 col-lg-7">
                <nav class="header__menu">
                    <ul>
                        ...
                        <li><a href="<%=request.getContextPath()%>/views/user/shop.jsp">Blog</a></li>
                        <li><a href="<%=request.getContextPath()%>/views/user/shop.jsp">Contact</a></li>
                    </ul>
                </nav>
            </div>
            <div class="col-lg-3">
    ...
    <div class="container">
                    ...
                    <table  >
                        ...
                        <tr>
                            <td class="cart__product__item">
                                <img src="<%=request.getContextPath()%>/views/img/shop-cartDetail/cp-1.jpg" alt="">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="cart__btn">
                    <a href="<%=request.getContextPath()%>/views/user/shop.jsp">Continue Shopping</a>
                </div>
            </div>
        </div>
        <div class="row">

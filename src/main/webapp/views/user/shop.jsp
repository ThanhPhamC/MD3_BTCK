    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="sidebar__categories">
                        ...
                        <div class="categories__accordion">
                            <div class="accordion" id="accordionExample">
                                ...
                                <div class="card">
                                    <div class="card-heading ${catId == cat.catalogId ? "active" :"" } ">
                                        <a  data-toggle="collapse" data-target="#${cat.catalogId}">${cat.catalogName}</a>
                                    </div>
                                    <div id="${cat.catalogId}" class="collapse show" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <ul>
                                                <div id="child">
                                                <li ><a href="#"></a></li>
            ...
            <div class="col-lg-9 col-md-9">
                <div class="row">
                    <c:forEach items="${ListByCatId}" var="pr">
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg"
                                     data-setbg="<%=request.getContextPath()%>/imgProduct/${pr.productImg}">
                                    <ul class="product__hover">
                                        <li><a href="<%=request.getContextPath()%>/imgProduct/${pr.productImg}"
                                               class="image-popup"><span class="arrow_expand"></span></a></li>
                                        <li><a onclick="addTobag()" class="addWhishList" href="#"><span class="icon_heart_alt"></span></a><input type="hidden" id="productId" value="${pr.productId}"></li>
                                        <li><a  href="<%=request.getContextPath()%>/HomeServlet?action=Detail&&productId=${pr.productId}"><span class="bi bi-amd"></span></a></li>
                                    </ul>
                                </div>
                                <div class="product__item__text">
                                    <h6>
                                        <a type="button" href="<%=request.getContextPath()%>/HomeServlet?action=Detail&&productId=${pr.productId}">${pr.productName}</a>
                                    </h6>
                                    <div class="rating">
                                    ...
                                    <div class="product__price">${pr.exportPrice*(1-pr.discount/100)}
                                        VND<span>${pr.exportPrice}</span></div>
                                </div>
                            </div>
                        </div>
                    </c:forEach>
                        <div class="product__item">
                            <div class="product__item__pic set-bg"
                                 data-setbg="<%=request.getContextPath()%>/views/img/shop/shop-7.jpg">
                                <ul class="product__hover">
                                    <li><a href="<%=request.getContextPath()%>/views/img/shop/shop-7.jpg"
                                           class="image-popup"><span class="arrow_expand"></span></a></li>
                                    <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                    <li><a href="#"><span class="product__hover icon_bag_alt"></span></a></li>
                                </ul>
                            </div>
                            <div class="product__item__text">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product__item">
                            <div class="product__item__pic set-bg"
                                 data-setbg="<%=request.getContextPath()%>/views/img/shop/shop-8.jpg">
                                <div class="label stockout stockblue">Out Of Stock</div>
                                <ul class="product__hover">
                                    <li><a href="<%=request.getContextPath()%>/views/img/shop/shop-8.jpg"
                                           class="image-popup"><span class="arrow_expand"></span></a></li>
                                    <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product__item sale">
                            <div class="product__item__pic set-bg"
                                 data-setbg="<%=request.getContextPath()%>/views/img/shop/shop-9.jpg">
                                <div class="label">Sale</div>
                                <ul class="product__hover">
                                    <li><a href="<%=request.getContextPath()%>/views/img/shop/shop-9.jpg"
                                           class="image-popup"><span class="arrow_expand"></span></a></li>
                                    <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                    <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                                </ul>
...
<script type="text/javascript">
    function searshowChild(data) {
        var showChild=data.value;
        $.ajax({
            type:'GET',
    ...
    $(document).on('click','ul .addWhishList',function (){
        let proId = $(this).parent().find('#productId').val();
        alert(proId)
        $.ajax({
            type:'GET',
            url: '${pageContext.request.contextPath}/HomeServlet?action=addWishList&&productId='+catId,
            success:function (){
